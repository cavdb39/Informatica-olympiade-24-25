...
begin_total_ms = int(1000*(begin_inputs[0]*3600+begin_inputs[1]*60+begin_inputs[2]))
...
if net_total_ms < 0:
    raise ValueError(f"Begin time ({begin_total_ms}) cannot be greater than end time({end_total_ms}).")
